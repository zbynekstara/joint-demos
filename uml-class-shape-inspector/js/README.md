# JointJS+: UML Class Shape Inspector (JavaScript) <a href="https://www.jointjs.com/jointjs-plus"><img src="../../jointjs-plus-badge.svg" alt="JointJS+" width="123" align="right" /></a>
...
This demo is also available online at [jointjs.com](https://jointjs.com/demos/uml-class-shape-inspector).
...
```bash
npx @joint/cli download uml-class-shape-inspector/js
```
