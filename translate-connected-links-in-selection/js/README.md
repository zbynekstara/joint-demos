# JointJS+: Translate Connected Links In Selection (JavaScript) <a href="https://www.jointjs.com/jointjs-plus"><img src="../../jointjs-plus-badge.svg" alt="JointJS+" width="123" align="right" /></a>
...
This demo is also available online at [jointjs.com](https://jointjs.com/demos/translate-connected-links-in-selection).
...
```bash
npx @joint/cli download translate-connected-links-in-selection/js
```
