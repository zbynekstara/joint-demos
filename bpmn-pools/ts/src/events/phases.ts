...
export function onPhaseDrag(paper: dia.Paper, elementView: dia.ElementView, evt: dia.Event, x: number, y: number) {
...
export function onPhaseDragEnd(paper: dia.Paper, _elementView: dia.ElementView, evt: dia.Event, _x: number, _y: number) {
...
export function onPhaseDrop(_paper: dia.Paper, phaseView: dia.ElementView, evt: dia.Event, x: number, y: number) {
    const phase = phaseView.model as shapes.bpmn2.Phase;
