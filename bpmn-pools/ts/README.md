# JointJS+: BPMN Pools (TypeScript) <a href="https://www.jointjs.com/jointjs-plus"><img src="../../jointjs-plus-badge.svg" alt="JointJS+" width="123" align="right" /></a>

BPMN pools, swimlanes and phases.

This demo is also available online at [jointjs.com](https://jointjs.com/demos/bpmn-pools).
...
```bash
npx @joint/cli download bpmn-pools/ts
```
