# JointJS: Marey Chart (JavaScript)

This demo visualizes a train scheduling Marey chart with interactive panning and zooming.

<a href="https://stackblitz.com/github/clientio/joint-demos/tree/main/marey-chart/js" target="_blank">
  <img
...
This demo is also available online at [jointjs.com](https://www.jointjs.com/demos/marey-chart).
...
```bash
npx @joint/cli download marey-chart/js
```
