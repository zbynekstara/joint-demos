# JointJS+: Container Layout (JavaScript) <a href="https://www.jointjs.com/jointjs-plus"><img src="../../jointjs-plus-badge.svg" alt="JointJS+" width="123" align="right" /></a>

Container Layout is a JointJS+ demo application that demonstrates how to combine 2 different types of layouts.
...
```bash
npx @joint/cli download container-layout/js
```
