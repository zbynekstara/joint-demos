# JointJS+: Visio Flowchart Import (JavaScript) <a href="https://www.jointjs.com/jointjs-plus"><img src="../../jointjs-plus-badge.svg" alt="JointJS+" width="123" align="right" /></a>

Convert Microsoft Visio Cross-Functional FlowChart VSDX file to a JointJS diagram.

This demo is also available online at [jointjs.com](https://jointjs.com/demos/visio-flowchart-import).
...
```bash
npx @joint/cli download visio-flowchart-import/js
```
