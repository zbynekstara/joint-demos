# JointJS+: Tabs (Angular) <a href="https://www.jointjs.com/jointjs-plus"><img src="../jointjs-plus-badge.svg" alt="JointJS+" width="123" align="right" /></a>

This is an Angular version of the Tabs demo that allows the user to display multiple JointJS diagrams while navigating them via a Tabs component.
...
```bash
npx @joint/cli download tabs/angular
```
