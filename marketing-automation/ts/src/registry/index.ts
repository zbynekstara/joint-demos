 ...
 */
export function resolveTriggerCriteriaProvider(registry: TriggerProviderRegistry, criteriaKey: string | null): [TriggerProviderDefinition, TriggerDefinition] | null {
    if (typeof criteriaKey !== 'string') return null;
