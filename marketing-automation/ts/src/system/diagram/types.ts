...
export interface SystemModel extends dia.Cell {
    ...
    /**
     * Get the data path for this model in the diagram data structure.
     */
    getDataPath(): string;
}

/**
 * Function type for sorting children of a node.
 */
export type SortIteratee<T extends dia.Element> = (targetEl: T) => number;
