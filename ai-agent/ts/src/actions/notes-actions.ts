import { V, type dia, mvc } from '@joint/plus';
import { Attribute } from '../diagram/const';
import Theme from '../diagram/theme';

import type { App } from '../app';
import type { Note } from '../diagram/models';
 ...
 */
export function openNoteEditor(app: App, note: Note) {
...
function createTextareaElement(note: Note): HTMLTextAreaElement {
...
function transformEditor(textareaEl: HTMLTextAreaElement, note: Note, paper: dia.Paper) {
