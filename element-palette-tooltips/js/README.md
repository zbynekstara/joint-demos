# JointJS+: Element Palette Tooltips (JavaScript) <a href="https://www.jointjs.com/jointjs-plus"><img src="../../jointjs-plus-badge.svg" alt="JointJS+" width="123" align="right" /></a>
...
This demo is also available online at [jointjs.com](https://jointjs.com/demos/element-palette-tooltips).
...
```bash
npx @joint/cli download element-palette-tooltips/js
```
