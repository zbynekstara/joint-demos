# JointJS+: Constellation (JavaScript) <a href="https://www.jointjs.com/jointjs-plus"><img src="../../jointjs-plus-badge.svg" alt="JointJS+" width="123" align="right" /></a>

Constellation is a JointJS+ demo application built with JointJS+.

This demo is also available online at [jointjs.com](https://jointjs.com/demos/constellation).
...
```bash
npx @joint/cli download constellation/js
```
