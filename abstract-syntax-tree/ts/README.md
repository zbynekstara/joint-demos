# JointJS+: AST Visualizer (TypeScript) <a href="https://www.jointjs.com/jointjs-plus"><img src="../../jointjs-plus-badge.svg" alt="JointJS+" width="123" align="right" /></a>

Display abstract syntax tree using JointJS graph.
...
```bash
npx @joint/cli download abstract-syntax-tree/ts
```
