# JointJS+: Organizational Chart (TypeScript) <a href="https://www.jointjs.com/jointjs-plus"><img src="../../jointjs-plus-badge.svg" alt="JointJS+" width="123" align="right" /></a>

Organizational Chart is a JointJS+ demo application that enables you to easily visualize your organizational structure.

This demo is also available online at [jointjs.com](https://jointjs.com/demos/organizational-chart).
...
```bash
npx @joint/cli download organizational-chart/ts
```
