# JointJS+: Tokens (JavaScript) <a href="https://www.jointjs.com/jointjs-plus"><img src="../../jointjs-plus-badge.svg" alt="JointJS+" width="123" align="right" /></a>

Tokens is a JointJS+ demo application that showcases visualization of Token events between nodes, and their transitions over time.
...
```bash
npx @joint/cli download tokens/js
```
