# JointJS+: Automatic link teleports (JavaScript) <a href="https://www.jointjs.com/jointjs-plus"><img src="../../jointjs-plus-badge.svg" alt="JointJS+" width="123" align="right" /></a>
...
This demo is also available online at [jointjs.com](https://jointjs.com/demos/automatic-link-teleports).
...
```bash
npx @joint/cli download automatic-link-teleports/js
```
