# JointJS: Rectangular Layout (JavaScript)
...
This demo is also available online at [jointjs.com](https://jointjs.com/demos/rectangular-layout).
...
```bash
npx @joint/cli download rectangular-layout/js
```
