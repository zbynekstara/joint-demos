# JointJS+: Rich Text Editor (TypeScript) <a href="https://www.jointjs.com/jointjs-plus"><img src="../../jointjs-plus-badge.svg" alt="JointJS+" width="123" align="right" /></a>
...
```bash
npx @joint/cli download rich-text-editor/ts
```
