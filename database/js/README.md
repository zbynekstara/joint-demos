# JointJS+: Database (JavaScript) <a href="https://www.jointjs.com/jointjs-plus"><img src="../../jointjs-plus-badge.svg" alt="JointJS+" width="123" align="right" /></a>

Database is a JointJS+ demo application that allows you to design and visualize information systems.

This demo is also available online at [jointjs.com](https://jointjs.com/demos/database).
...
```bash
npx @joint/cli download database/js
```
