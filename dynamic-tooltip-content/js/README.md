# JointJS+: Dynamic Tooltip Content (JavaScript) <a href="https://www.jointjs.com/jointjs-plus"><img src="../../jointjs-plus-badge.svg" alt="JointJS+" width="123" align="right" /></a>
...
This demo is also available online at [jointjs.com](https://jointjs.com/demos/dynamic-tooltip-content).
...
```bash
npx @joint/cli download dynamic-tooltip-content/js
```
