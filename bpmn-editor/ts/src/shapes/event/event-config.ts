...
export enum EventShapeTypes {
    // Start
    START = 'event.Start',
    MESSAGE_START = 'event.MessageStart',
    TIMER_START = 'event.TimerStart',
    CONDITIONAL_START = 'event.ConditionalStart',
    SIGNAL_START = 'event.SignalStart',
    // Intermediate Catching
    INTERMEDIATE_CATCHING = 'event.IntermediateCatching',
    MESSAGE_INTERMEDIATE_CATCHING = 'event.MessageIntermediateCatching',
    TIMER_INTERMEDIATE_CATCHING = 'event.TimerIntermediateCatching',
    CONDITIONAL_INTERMEDIATE_CATCHING = 'event.ConditionalIntermediateCatching',
    LINK_INTERMEDIATE_CATCHING = 'event.LinkIntermediateCatching',
    SIGNAL_INTERMEDIATE_CATCHING = 'event.SignalIntermediateCatching',
    // Intermediate boundary
    INTERMEDIATE_BOUNDARY = 'event.IntermediateBoundary',
    MESSAGE_INTERMEDIATE_BOUNDARY = 'event.MessageIntermediateBoundary',
    TIMER_INTERMEDIATE_BOUNDARY = 'event.TimerIntermediateBoundary',
    CONDITIONAL_INTERMEDIATE_BOUNDARY = 'event.ConditionalIntermediateBoundary',
    SIGNAL_INTERMEDIATE_BOUNDARY = 'event.SignalIntermediateBoundary',
    ERROR_INTERMEDIATE_BOUNDARY = 'event.ErrorIntermediateBoundary',
    ESCALATION_INTERMEDIATE_BOUNDARY = 'event.EscalationIntermediateBoundary',
    COMPENSATION_INTERMEDIATE_BOUNDARY = 'event.CompensationIntermediateBoundary',
    CANCEL_INTERMEDIATE_BOUNDARY = 'event.CancelIntermediateBoundary',
    // Intermediate boundary non-interrupting
    MESSAGE_INTERMEDIATE_BOUNDARY_NON_INTERRUPTING = 'event.MessageIntermediateBoundaryNonInterrupting',
    TIMER_INTERMEDIATE_BOUNDARY_NON_INTERRUPTING = 'event.TimerIntermediateBoundaryNonInterrupting',
    CONDITIONAL_INTERMEDIATE_BOUNDARY_NON_INTERRUPTING = 'event.ConditionalIntermediateBoundaryNonInterrupting',
    SIGNAL_INTERMEDIATE_BOUNDARY_NON_INTERRUPTING = 'event.SignalIntermediateBoundaryNonInterrupting',
    ESCALATION_INTERMEDIATE_BOUNDARY_NON_INTERRUPTING = 'event.EscalationIntermediateBoundaryNonInterrupting',
    // Intermediate throwing
    INTERMEDIATE_THROWING = 'event.IntermediateThrowing',
    MESSAGE_INTERMEDIATE_THROWING = 'event.MessageIntermediateThrowing',
    LINK_INTERMEDIATE_THROWING = 'event.LinkIntermediateThrowing',
    SIGNAL_INTERMEDIATE_THROWING = 'event.SignalIntermediateThrowing',
    ESCALATION_INTERMEDIATE_THROWING = 'event.EscalationIntermediateThrowing',
    COMPENSATION_INTERMEDIATE_THROWING = 'event.CompensationIntermediateThrowing',
    // End
    END = 'event.End',
    MESSAGE_END = 'event.MessageEnd',
    SIGNAL_END = 'event.SignalEnd',
    ERROR_END = 'event.ErrorEnd',
    ESCALATION_END = 'event.EscalationEnd',
    TERMINATION_END = 'event.TerminationEnd',
    COMPENSATION_END = 'event.CompensationEnd',
    CANCEL_END = 'event.CancelEnd'
}
