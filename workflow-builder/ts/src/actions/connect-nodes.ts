...
type StartConnectionInteractionOptions = {
    ...
    /**
     * Port ID to start the connection from
     */
    portId?: string;
}
 ...
 */
export function startPortConnectionInteraction(
    ctx: App,
    nodeView: dia.ElementView,
    evt: dia.Event,
    ...
    const linkView = nodeView.eventData(evt).linkView as dia.LinkView;
    if (!linkView) {
