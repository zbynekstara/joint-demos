 ...
 */
import type { ActionDefinition, ActionProviderDefinition, ActionProviderRegistry, ControlDefinition, ControlRegistry, TriggerDefinition, TriggerProviderDefinition, TriggerProviderRegistry } from './types';
 ...
 */
export function resolveControlType(registry: ControlRegistry, controlKey: string | null): ControlDefinition | null {
    if (typeof controlKey !== 'string') return null;
