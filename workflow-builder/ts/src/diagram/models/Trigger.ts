...
interface TriggerAttributes extends DiagramNodeAttributes {
    [Attribute.TriggerKey]: string | null;
}

export interface TriggerConfiguration {
    provider: TriggerProviderDefinition;
    trigger: TriggerDefinition;
}

export default class Trigger extends DiagramNode<TriggerAttributes> implements OutlineNode, Configurable<TriggerConfiguration> {
    static override type = TYPE;

    static override growthLimit = 1;

    configuration: TriggerConfiguration | null = null;
    ...
    setConfigurationKey(triggerKey: string, options?: dia.Cell.Options) {
    ...
    updateConfiguration(configuration: TriggerConfiguration) {
