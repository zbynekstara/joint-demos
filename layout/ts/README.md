# JointJS+: Layout (TypeScript) <a href="https://www.jointjs.com/jointjs-plus"><img src="../../jointjs-plus-badge.svg" alt="JointJS+" width="123" align="right" /></a>

Layout is a JointJS+ demo application that demonstrates how to combine 2 different types of layouts.

This demo is also available online at [jointjs.com](https://jointjs.com/demos/layout).
...
```bash
npx @joint/cli download layout/ts
```
