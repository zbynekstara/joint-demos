# JointJS+: Tree Graph with Add Buttons (JavaScript) <a href="https://www.jointjs.com/jointjs-plus"><img src="../../jointjs-plus-badge.svg" alt="JointJS+" width="123" align="right" /></a>
...
This demo is also available online at [jointjs.com](https://jointjs.com/demos/tree-graph-with-add-buttons).
...
```bash
npx @joint/cli download tree-graph-with-add-buttons/js
```
