# JointJS: Petri Nets (JavaScript)

This demo simulates a Petri net with animated token transitions between places.

<a href="https://stackblitz.com/github/clientio/joint-demos/tree/main/petri-nets/js" target="_blank">
  <img
...
This demo is also available online at [jointjs.com](https://www.jointjs.com/demos/petri-nets).
...
```bash
npx @joint/cli download petri-nets/js
```
