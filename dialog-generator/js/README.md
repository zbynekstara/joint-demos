# JointJS+: Dialog Generator (JavaScript) <a href="https://www.jointjs.com/jointjs-plus"><img src="../../jointjs-plus-badge.svg" alt="JointJS+" width="123" align="right" /></a>

Dialog Generator is a JointJS+ demo application that demonstrates how to create a question and answer diagram. Users can create a dialog, then preview the result in an interactive manner.

This demo is also available online at [jointjs.com](https://jointjs.com/demos/dialog-generator).
...
```bash
npx @joint/cli download dialog-generator/js
```
