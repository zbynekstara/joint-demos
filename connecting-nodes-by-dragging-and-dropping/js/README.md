# JointJS+: Connecting nodes by dragging and dropping (JavaScript) <a href="https://www.jointjs.com/jointjs-plus"><img src="../../jointjs-plus-badge.svg" alt="JointJS+" width="123" align="right" /></a>
...
This demo is also available online at [jointjs.com](https://jointjs.com/demos/connecting-nodes-by-dragging-and-dropping).
...
```bash
npx @joint/cli download connecting-nodes-by-dragging-and-dropping/js
```
