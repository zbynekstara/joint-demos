# JointJS+: Distances (JavaScript) <a href="https://www.jointjs.com/jointjs-plus"><img src="../../jointjs-plus-badge.svg" alt="JointJS+" width="123" align="right" /></a>

Distances is a JointJS+ demo application that allows you to dynamically calculate the distance between two points.
...
```bash
npx @joint/cli download distances/js
```
