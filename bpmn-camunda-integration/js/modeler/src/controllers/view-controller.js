...
function onLinkPointerMove({ paper }, linkView, evt, x, y) {
    ...
    let hoveredView = paper.findElementViewsAtPoint({ x, y }).sort((a, b) => { var _a, _b; return ((_a = b.model.get('z')) !== null && _a !== void 0 ? _a : 0) - ((_b = a.model.get('z')) !== null && _b !== void 0 ? _b : 0); })[0];
