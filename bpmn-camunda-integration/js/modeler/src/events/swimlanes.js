...
export function onSwimlaneDragEnd(paper, elementView, evt, x, y) {
    ...
    checkSwimlaneDrop(elementView.model, (_a = evt.data.poolView) === null || _a === void 0 ? void 0 : _a.model, x, y);
}
...
export function onSwimlaneDrop(_paper, elementView, evt, x, y) {
    ...
    return checkSwimlaneDrop(elementView.model, (_a = evt.data.poolView) === null || _a === void 0 ? void 0 : _a.model, x, y);
}
