# JointJS+: Multidirectional Tree (JavaScript) <a href="https://www.jointjs.com/jointjs-plus"><img src="../../jointjs-plus-badge.svg" alt="JointJS+" width="123" align="right" /></a>

Multidirectional Tree is a JointJS+ demo application that utilizes the JointJS+ TreeLayout plugin to create a tidy node and link diagram.
...
```bash
npx @joint/cli download multidirectional-tree/js
```
