# JointJS: Puzzle (JavaScript)

This demo generates interactive jigsaw puzzles from images with draggable and rotatable pieces.

<a href="https://stackblitz.com/github/clientio/joint-demos/tree/main/puzzle/js" target="_blank">
  <img
...
This demo is also available online at [jointjs.com](https://www.jointjs.com/demos/puzzle).
...
```bash
npx @joint/cli download puzzle/js
```
